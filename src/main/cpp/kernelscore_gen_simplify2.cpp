...
//	#pragma simd reduction(+: exps)
	for ( ppip273p280 = __hpat_loop_start_7; ppip273p280 <= (int64_t)__hpat_loop_end_7; ppip273p280 += 1)
	{
		...
		for ( parfor_index_1_17 = 1; parfor_index_1_17 <= (int64_t)3; parfor_index_1_17 += 1)
		{
			...
			parallel_ir_new_array_name_17_1.ARRAYELEM(parfor_index_1_17) = SSAValue7;
		}
		;
		for ( parfor_index_1_21 = 1; parfor_index_1_21 <= (int64_t)3; parfor_index_1_21 += 1)
		{
			;
			parallel_ir_array_temp_SSAValue17_22_1 = parallel_ir_new_array_name_17_1.ARRAYELEM(parfor_index_1_21);
			SSAValue8 = (int32_t)(2);
			SSAValue9 = pow(parallel_ir_array_temp_SSAValue17_22_1, SSAValue8);
			parallel_ir_new_array_name_17_1.ARRAYELEM(parfor_index_1_21) = SSAValue9;
		}
		;
		for ( parfor_index_1_25 = 1; parfor_index_1_25 <= (int64_t)3; parfor_index_1_25 += 1)
		{
			;
			parallel_ir_array_temp_SSAValue18_26_1 = parallel_ir_new_array_name_17_1.ARRAYELEM(parfor_index_1_25);
			SSAValue10 = -(parallel_ir_array_temp_SSAValue18_26_1);
			parallel_ir_new_array_name_17_1.ARRAYELEM(parfor_index_1_25) = SSAValue10;
		}
		;
		for ( parfor_index_1_29 = 1; parfor_index_1_29 <= (int64_t)3; parfor_index_1_29 += 1)
		{
			;
			parallel_ir_array_temp_SSAValue2_30_1 = parallel_ir_new_array_name_17_1.ARRAYELEM(parfor_index_1_29);
			SSAValue12 = (parallel_ir_array_temp_SSAValue2_30_1) / (SSAValue25pp2);
			parallel_ir_new_array_name_17_1.ARRAYELEM(parfor_index_1_29) = SSAValue12;
		}
		;
		parallel_ir_save_array_len_1_33 = parallel_ir_new_array_name_17_1.ARRAYSIZE(1);
		...
		{
			;
			parallel_ir_array_temp__4_35_1 = parallel_ir_new_array_name_17_1.ARRAYELEM(parfor_index_1_33);
			parallel_ir_reduction_output_33 = std::min((double)parallel_ir_reduction_output_33,(double)parallel_ir_array_temp__4_35_1);
		}
		;
		SSAValue23 = (parallel_ir_reduction_output_33) - (SSAValue22);
		for ( parfor_index_1_37 = 1; parfor_index_1_37 <= (int64_t)3; parfor_index_1_37 += 1)
		{
			;
			parallel_ir_array_temp__4_38_1 = parallel_ir_new_array_name_17_1.ARRAYELEM(parfor_index_1_37);
			SSAValue15 = (parallel_ir_array_temp__4_38_1) - (parallel_ir_reduction_output_33);
			parallel_ir_new_array_name_17_1.ARRAYELEM(parfor_index_1_37) = SSAValue15;
		}
		;
		for ( parfor_index_1_41 = 1; parfor_index_1_41 <= (int64_t)3; parfor_index_1_41 += 1)
		{
			;
			parallel_ir_array_temp_SSAValue31_42_1 = parallel_ir_new_array_name_17_1.ARRAYELEM(parfor_index_1_41);
			SSAValue17 = exp(parallel_ir_array_temp_SSAValue31_42_1);
			parallel_ir_new_array_name_17_1.ARRAYELEM(parfor_index_1_41) = SSAValue17;
		}
		;
		parallel_ir_save_array_len_1_45 = parallel_ir_new_array_name_17_1.ARRAYSIZE(1);
		...
		{
			;
			parallel_ir_array_temp_SSAValue32_47_1 = parallel_ir_new_array_name_17_1.ARRAYELEM(parfor_index_1_45);
			parallel_ir_reduction_output_45 = (parallel_ir_reduction_output_45+parallel_ir_array_temp_SSAValue32_47_1);
		}
		;
		SSAValue24 = log(parallel_ir_reduction_output_45);;
