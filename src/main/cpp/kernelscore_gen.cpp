...
void ppkernelscore_testp271(int64_t n, double * __restrict ret0)
{
    ...
    for ( ppip273p280 = __hpat_loop_start_7; ppip273p280 <= (int64_t)__hpat_loop_end_7; ppip273p280 += 1)
    {
        ...
        SSAValue21 = pow(b, SSAValue26);
        SSAValue27 = (double)2;
        SSAValue25pp2 = (SSAValue27) * (SSAValue21);
        SSAValue28 = (double)N;
        SSAValue29 = (b) * (SSAValue28);
        ...
        for ( parfor_index_1_17 = 1; parfor_index_1_17 <= (int64_t)parallel_ir_save_array_len_1_17; parfor_index_1_17 += 1)
        {
            ...
            parallel_ir_array_temp__23_20_1 = SSAValue31;
            ...
            SSAValue34 = -(parallel_ir_array_temp_SSAValue18_27_1);
            parallel_ir_array_temp_SSAValue18_29_2 = SSAValue34;
            parallel_ir_array_temp_SSAValue2_32_1 = parallel_ir_array_temp_SSAValue18_29_2;
            SSAValue35 = (parallel_ir_array_temp_SSAValue2_32_1) / (SSAValue25pp2);
            parallel_ir_array_temp_SSAValue2_34_2 = SSAValue35;
            parallel_ir_new_array_name_17_1.ARRAYELEM(parfor_index_1_17) = parallel_ir_array_temp_SSAValue2_34_2;
            parallel_ir_array_temp__4_38_1 = parallel_ir_array_temp_SSAValue2_34_2;
            SSAValue36 = parallel_ir_array_temp__4_38_1;
            ...
            SSAValue41 = (parallel_ir_array_temp__4_38_1) < (parallel_ir_reduction_output_36);
            SSAValue42 = (SSAValue39) & (SSAValue40);
            (SSAValue41) | (SSAValue42);
            SSAValue43 = (parallel_ir_array_temp__4_38_1) != (parallel_ir_array_temp__4_38_1);
            SSAValue44 = (parallel_ir_reduction_output_36) != (parallel_ir_reduction_output_36);
            SSAValue45 = (SSAValue41) | (SSAValue42);
            SSAValue46 = (SSAValue43) ? (parallel_ir_reduction_output_36) : (parallel_ir_array_temp__4_38_1);
            SSAValue47 = (SSAValue44) ? (parallel_ir_array_temp__4_38_1) : (parallel_ir_reduction_output_36);
        ...
        SSAValue23 = (SSAValue20) - (SSAValue22);
        ...
        for ( parfor_index_1_41 = 1; parfor_index_1_41 <= (int64_t)parallel_ir_save_array_len_1_41; parfor_index_1_41 += 1)
        {
            ...
            SSAValue51 = (SSAValue50) < (0);
            SSAValue0 = (SSAValue49) < (0);
            SSAValue1 = !(SSAValue51);
            (SSAValue0) & (SSAValue1);
            SSAValue2 = (parallel_ir_array_temp__4_43_1) < (parallel_ir_reduction_output_41);
            SSAValue3 = (SSAValue0) & (SSAValue1);
            (SSAValue2) | (SSAValue3);
            SSAValue4 = (parallel_ir_array_temp__4_43_1) != (parallel_ir_array_temp__4_43_1);
            SSAValue5 = (parallel_ir_reduction_output_41) != (parallel_ir_reduction_output_41);
            SSAValue6 = (SSAValue2) | (SSAValue3);
            SSAValue7 = (SSAValue4) ? (parallel_ir_reduction_output_41) : (parallel_ir_array_temp__4_43_1);
            SSAValue8 = (SSAValue5) ? (parallel_ir_array_temp__4_43_1) : (parallel_ir_reduction_output_41);
        ...
        parallel_ir_save_array_len_1_45 = d.ARRAYSIZE(1);
        ...
        for ( parfor_index_1_45 = 1; parfor_index_1_45 <= (int64_t)parallel_ir_save_array_len_1_45; parfor_index_1_45 += 1)
        {
            ...
            SSAValue12 = (parallel_ir_array_temp__4_46_1) - (SSAValue31pp3);
            parallel_ir_array_temp__4_48_2 = SSAValue12;
            parallel_ir_array_temp_SSAValue32_50_1 = parallel_ir_array_temp__4_48_2;
            SSAValue15 = exp(parallel_ir_array_temp_SSAValue32_50_1);
            parallel_ir_array_temp_SSAValue32_52_2 = SSAValue15;
            parallel_ir_array_temp_SSAValue33_56_1 = parallel_ir_array_temp_SSAValue32_52_2;
            SSAValue17 = (parallel_ir_reduction_output_54) + (parallel_ir_array_temp_SSAValue33_56_1);
            parallel_ir_reduction_output_54 = SSAValue17;
        }
        ;
        SSAValue30 = parallel_ir_reduction_output_54;
        SSAValue24 = log(SSAValue30);;
