...
void ppkmeansp271(int64_t numCenter, int64_t iterNum, int64_t N,  j2c_array< double >  * __restrict ret0)
{
	...
	int64_t __hpat_dist_arr_start_88;
	int64_t __hpat_dist_arr_div_88;
	int64_t __hpat_dist_arr_count_88;
	int64_t __hpat_loop_start_25;
	int64_t __hpat_loop_end_25;
	int64_t __hpat_loop_div_25;
	int64_t __hpat_loop_start_84;
	int64_t __hpat_loop_end_84;
	int64_t __hpat_loop_div_84;
	double __hpat_reduce_89;
	int64_t __hpat_reduce_90;
	...
	_pa_rand_gen_arr = j2c_array<double>::new_j2c_array_2d(NULL, 10, __hpat_dist_arr_count_87);
	...
	while (1)
	{
		...
		if (!(SSAValue13)) break;
		ptempp = (ptempp) + (1);
		__hpat_dist_arr_div_88 = (N) / (__hpat_num_pes);
		__hpat_dist_arr_start_88 = (__hpat_node_id) * (__hpat_dist_arr_div_88);
		__hpat_dist_arr_count_88 = ((__hpat_node_id==__hpat_num_pes-1) ? N-__hpat_node_id*__hpat_dist_arr_div_88 : __hpat_dist_arr_div_88);
		SSAValue32 = j2c_array<int64_t>::new_j2c_array_1d(NULL, __hpat_dist_arr_count_88);
		...
		for ( parfor_index_1_25 = __hpat_loop_start_25; parfor_index_1_25 <= (int64_t)__hpat_loop_end_25; parfor_index_1_25 += 1)
		{
			...
			while (1)
			{
				...
				;
				parallel_ir_save_array_len_1_57 = parallel_ir_new_array_name_46_1.ARRAYSIZE(1);
			...
			;
			SSAValue20 = m.idx;
			SSAValue32.ARRAYELEM(((parfor_index_1_25) - (__hpat_loop_start_25)) + (1)) = SSAValue20;
		}
		;
		for ( parfor_index_2_75 = 1; parfor_index_2_75 <= (int64_t)numCenter; parfor_index_2_75 += 1)
		{
			...
			{
				;
				parallel_ir_reduction_output_88 = 0.0;
				parallel_ir_reduction_output_100 = 0;
				__hpat_loop_div_84 = (N) / (__hpat_num_pes);
				__hpat_loop_start_84 = ((__hpat_node_id) * (__hpat_loop_div_84)) + (1);
				__hpat_loop_end_84 = ((__hpat_node_id==__hpat_num_pes-1) ? N : (__hpat_node_id+1)*__hpat_loop_div_84);
				for ( parfor_index_1_84 = __hpat_loop_start_84; parfor_index_1_84 <= (int64_t)__hpat_loop_end_84; parfor_index_1_84 += 1)
				{
					;
					parallel_ir_array_temp__7_85_1 = SSAValue32.ARRAYELEM(((parfor_index_1_84) - (__hpat_loop_start_84)) + (1));
					...
					{
						;
						parallel_ir_array_temp__9_90_1 = _pa_rand_gen_arr.ARRAYELEM(parfor_index_1_75,((parfor_index_1_84) - (__hpat_loop_start_84)) + (1));
						parallel_ir_reduction_output_88 = (parallel_ir_reduction_output_88+parallel_ir_array_temp__9_90_1);
					}
					;
					parallel_ir_array_temp__7_93_1 = SSAValue32.ARRAYELEM(((parfor_index_1_84) - (__hpat_loop_start_84)) + (1));
					SSAValue18 = (parallel_ir_array_temp__7_93_1 == parfor_index_2_75);
					SSAValue31 = (SSAValue18) ? (1) : (0);
					parallel_ir_reduction_output_100 = (parallel_ir_reduction_output_100+SSAValue31);
				}
				;
				__hpat_reduce_89 = 0;
				MPI_Allreduce(&parallel_ir_reduction_output_88, &__hpat_reduce_89, 1, MPI_DOUBLE, MPI_SUM, MPI_COMM_WORLD);;
				parallel_ir_reduction_output_88 = __hpat_reduce_89;
				__hpat_reduce_90 = 0;
				MPI_Allreduce(&parallel_ir_reduction_output_100, &__hpat_reduce_90, 1, MPI_INT64_T, MPI_SUM, MPI_COMM_WORLD);;
				parallel_ir_reduction_output_100 = __hpat_reduce_90;
				SSAValue35 = (double)parallel_ir_reduction_output_100;
				SSAValue38 = (parallel_ir_reduction_output_88) / (SSAValue35);
				SSAValue0.ARRAYELEM(parfor_index_1_75,parfor_index_2_75) = SSAValue38;
			}
		}
		;
		centroids = SSAValue0;
