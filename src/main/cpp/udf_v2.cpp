...
void ppudf_testp271(ASCIIString&  file_name, double * __restrict ret0)
{
    ...
    double parallel_ir_array_temp__27_8_1;
    ...
    double parallel_ir_array_temp__33_12_1;
    int64_t parfor_index_1_14;
    double parallel_ir_array_temp__14_16_1;
    ...
    for ( parfor_index_1_5 = __hpat_loop_start_5; parfor_index_1_5 <= (int64_t)__hpat_loop_end_5; parfor_index_1_5 += 1)
    {
        ...
        SSAValue1 = SSAValue0;
        parallel_ir_array_temp__27_8_1 = SSAValue1;
        parallel_ir_new_array_name_5_1.ARRAYELEM(((parfor_index_1_5) - (__hpat_loop_start_5)) + (1)) = parallel_ir_array_temp__27_8_1;
        ...
        SSAValue6 = SSAValue5;
        parallel_ir_array_temp__33_12_1 = SSAValue6;
        parallel_ir_new_array_name_9_1.ARRAYELEM(((parfor_index_1_5) - (__hpat_loop_start_5)) + (1)) = parallel_ir_array_temp__33_12_1;
    }
    ;
    ...
    {
        ;
        parallel_ir_array_temp__14_16_1 = _df2_sx.ARRAYELEM(parfor_index_1_14);
        SSAValue7 = (parallel_ir_reduction_output_14) + (parallel_ir_array_temp__14_16_1);
        SSAValue8 = SSAValue7;
