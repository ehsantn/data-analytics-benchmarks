...
void ppmovingavg_testp271(ASCIIString&  file_name, double * __restrict ret0)
{
    ...
    label4 : ;
    for ( i19pp1 = 2; i19pp1 <= (int64_t)(_df_x.ARRAYSIZE(1)) - (1); i19pp1 += 1)
    {
        ;
        SSAValue0 = _df_x.ARRAYELEM((i19pp1) + (-1));
        SSAValue2 = _df_x.ARRAYELEM(i19pp1);
        SSAValue9 = (double)2;
        SSAValue4 = (SSAValue9) * (SSAValue2);
        SSAValue5 = (SSAValue0) + (SSAValue4);
        SSAValue7 = _df_x.ARRAYELEM((i19pp1) + (1));
        SSAValue8 = (SSAValue5) + (SSAValue7);
        pp_272p275 = (SSAValue8) / (4.0);
        SSAValue1.ARRAYELEM(i19pp1) = pp_272p275;
        pp_272p275;
    }
    ;
    ...
    ;
    SSAValue0 = recv_left_tmp;
    SSAValue2 = _df_x.ARRAYELEM(1);
    SSAValue9 = (double)2;
    SSAValue4 = (SSAValue9) * (SSAValue2);
    SSAValue5 = (SSAValue0) + (SSAValue4);
    SSAValue7 = _df_x.ARRAYELEM((1) + (1));
    SSAValue8 = (SSAValue5) + (SSAValue7);
    pp_272p275 = (SSAValue8) / (4.0);
    ...
    ;
    SSAValue0 = _df_x.ARRAYELEM((_df_x.ARRAYSIZE(1)) + (-1));
    SSAValue2 = _df_x.ARRAYELEM(_df_x.ARRAYSIZE(1));
    SSAValue9 = (double)2;
    SSAValue4 = (SSAValue9) * (SSAValue2);
    SSAValue5 = (SSAValue0) + (SSAValue4);
    SSAValue7 = recv_right_tmp;
    SSAValue8 = (SSAValue5) + (SSAValue7);
    pp_272p275 = (SSAValue8) / (4.0);
